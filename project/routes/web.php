...
Route::prefix('admin')->group(function () {
  ...
  Route::get('/body/edit/{id}/{id1}', 'Admin\BodyController@edit')->name('admin-body-edit');
  Route::post('/body/edit/{id}', 'Admin\BodyController@update')->name('admin-body-update');
  Route::get('/body/delete/{id}/{id1}', 'Admin\BodyController@destroy')->name('admin-body-delete');
  ...
  Route::get('/car/featuredCars', 'Admin\CarController@featuredCars')->name('admin.car.featuredCars');
  Route::post('/car/list', 'Admin\CarController@carList')->name('admin.car.list');
  Route::post('/car/featuredlist', 'Admin\CarController@carFeaturedList')->name('admin.car.featuredlist');
  Route::post('/car/specificationList', 'Admin\BodyController@specificationList')->name('admin.specification.list');
  ...
  Route::get('/car/{id}/edit', 'user\CarController@edit')->name('admin.car.edit');
  Route::post('/car/update', 'user\CarController@update')->name('admin.car.update');
...
Route::get('/cars/compare', 'Front\FrontendController@carcompare')->name('front.compare');
Route::post('/cars/getCars', 'Front\FrontendController@getCars')->name('front.getCars');
Route::post('/cars/getCarDetails', 'Front\FrontendController@getCarDetails')->name('front.getCarDetails');
Route::post('/cars/getCompareDetails', 'Front\FrontendController@getCompareDetails')->name('front.getCompareDetails');
