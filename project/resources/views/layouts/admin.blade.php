					...
					<ul class="list-unstyled components" id="accordion">
						...
						<li>
							...
							<ul class="collapse list-unstyled" id="specs" data-parent="#accordion">
								...
								<li>
									<a href="{{ route('admin-body-index') }}"><span>Specification Management</span></a>
								</li>
								<!-- <li>
						...
						<li>
							...
							<ul class="collapse list-unstyled @if(request()->path() == 'admin/car') show  @endif" id="car" data-parent="#accordion">
								<li><a href="{{ route('user.car.create') }}"> {{ $langg->lang69 }}</a></li>
								<li class="@if(request()->input('type') == 'all') active  @endif">
									<a href="{{ route('admin.car.index') }}"><span>All Cars</span></a>
								</li>
								<li class="@if(request()->input('type') == 'featured') active  @endif" class="@if(request()->input('type') == 'all') active  @endif">
									<a href="{{ route('admin.car.featuredCars') }}"><span>Featured Cars</span></a>
								</li>
						...
						<li>
							<a href="{{ route('admin-user-index') }}" class="wave-effect active"><i class="fas fa-users"></i>User Management</a>
						</li>
