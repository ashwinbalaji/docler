            ...
            <form class="add-form" id="geniusform" action="{{ route('user.car.store') }}" method="POST" enctype="multipart/form-data" novalidate>
              ...
              <div class="row">
                <div class="col-lg-4">
                  ...
                  <input class="input-field" type="text" name="car_name" placeholder="{{$langg->lang101}} {{$langg->lang102}}" value="">
                </div>
                <div class="col-lg-4">
                  <h4 class="heading mb-0">Price *</h4>
                  <input class="input-field" type="text" name="price" placeholder="Price" value="">
                </div>
                ...
                <div class="col-lg-7 offset-lg-3">
                  <div class="row">
                    <div class="col-lg-12">
                      ...
                      <textarea name="features" class="form-control nic-edit" rows="8" cols="80"></textarea>
                    </div>
                  </div>
                </div>
              </div>
